...
const AdminResp = ({ showMenu, setShowMenu }) => {
  return (
    <div
      className={`${
        showMenu ? "left-0" : "-left-[100%]"
      } fixed bottom-0 top-14 z-20 flex h-[100vh] w-[100%] flex-col lg:hidden justify-between dark:bg-gray-900 bg-white dark:text-white px-8 pb-6 pt-16 text-black transition-all duration-200 shadow-md`}
    >
      <div className="card">
        <nav className="mt-12">
