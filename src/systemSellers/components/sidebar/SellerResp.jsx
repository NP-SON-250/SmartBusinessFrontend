...
import { SellerSidebarMenu } from "./Seller_sidebar";
import { FaUserCircle } from "react-icons/fa";
import { Link } from "react-router-dom";

const SellerResp = ({ showMenu, setShowMenu }) => {
      ...
      <div className="card">
        <nav className="mt-12">
          ...
          <div className="flex flex-col gap-3 justify-center items-center pb-10 hover:text-primary">
              ...
              <div >
                <h1 className="-ml-7">Hello, Steven</h1>
                <h1 className="text-sm text-slate-500">Seller</h1>
              </div>
                </Link>
            </div>
