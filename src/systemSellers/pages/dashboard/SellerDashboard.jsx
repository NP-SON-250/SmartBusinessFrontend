...
const SaleDashboard = () => {
  return (
    <div className="bg-white pr-2 pt-16 dark:bg-gray-900 ">
            <div className="absolute lg:top-16 md:top-[4rem] top-22 p-5 lg:left-72 md:left-0  right-8 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-5 md:gap-10 gap-5">
            ...
            <div className="basis-[100%] grid lg:grid-cols-2 md:grid-cols-1 grid-cols-1 lg:pt-28 md:pt-48 pt-96 pr-0 p-2 gap-4 lg:ml-72">
              <div className="w-full md:mt-[20rem] lg:mt-10 bg-white dark:bg-gray-900 rounded-md">
                <div className="selection text-center p-4">
                  <select
                    name="month"
                    id="month"
                    className="w-1/2 text-center h-8 bg-transparent border border-gray-700 rounded-md text-gray-900 dark:bg-gray-900 dark:text-white"
                  >
              ...
              <div className="w-full lg:mt-10 md:mt-10 pt-0 bg-white dark:bg-gray-900 rounded-md">
