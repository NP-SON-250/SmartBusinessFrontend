    ...
    <div style={BannerImg} className="text-white -mb-10">
      <div className="container ">
        <div data-aos="zoom-in" className=" grid md:grid-cols-3 pb-44 pt-5">
          {/* company details */}
          <div className="py-6 px-0 md:-ml-10">
          ...
          <div className="text-center w-full lg:ml-96 md:ml-[15rem]">
            <p className="text-center text-white  hover:text-primary cursor-pointer hover:translate-x-1 duration-300 mt-10">
